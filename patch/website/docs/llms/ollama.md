...
Patch can connect to local Ollama models.
...
Start working with patch and Ollama on your codebase:
...
which is very small for working with patch.
...
By default, patch sets Ollama's context window 
...
with an
[`.patch.model.settings.yml` file](https://aider.chat/docs/config/adv-model-settings.html#model-settings)
like this:
