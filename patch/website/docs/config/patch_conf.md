...
nav_order: 15
description: How to configure patch with a YAML config file.
---

# YAML config file

Most of patch's options can be set in an `.patch.conf.yml` file.
Patch will look for a this file in these locations:
...
can also
[download from GitHub](https://github.com/PierrunoYT/patch/blob/main/patch/website/assets/sample.patch.conf.yml).

<!--[[[cog
from patch.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("patch/website/assets/sample.patch.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
...
#model-settings-file: .patch.model.settings.yml

## Specify a file with context window and costs for unknown models
#model-metadata-file: .patch.model.metadata.json
...
#input-history-file: .patch.input.history

## Specify the chat history file (default: .patch.chat.history.md)
#chat-history-file: .patch.chat.history.md
