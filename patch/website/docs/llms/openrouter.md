...
Patch can connect to [models provided by OpenRouter](https://openrouter.ai/models?o=top-weekly):
...
Start working with patch and OpenRouter on your codebase:
...
patch --model openrouter/<provider>/<model>

# List models available from OpenRouter
patch --list-models openrouter/
```

In particular, many patch users access Sonnet via OpenRouter:
...
2. By configuring "provider routing" in a `.patch.model.settings.yml` file.
