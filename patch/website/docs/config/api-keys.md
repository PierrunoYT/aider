...
Patch lets you specify API keys in a few ways:

- On the command line
- As environment variables
- In a `.env` file
- In your `.patch.conf.yml` config file

---

## OpenAI and Anthropic

Patch has special support for providing
...
[YAML config file](/docs/config/patch_conf.html), like this:
...
[`.patch.conf.yml` file](/docs/config/patch_conf.html)
