...
> This is the upstream [Aider](https://github.com/Aider-AI/aider) contributor
> agreement, retained for reference. Patch is an independent fork; there is no
> "Patch AI" legal entity. See [CONTRIBUTING.md](https://github.com/PierrunoYT/patch/blob/main/CONTRIBUTING.md)
> for how to contribute to Patch.
