...
def start_openrouter_oauth_flow(io, analytics):
    ...
    callback_url = f"http://localhost:{port}/callback/patch"
    auth_code = None
    server_error = None
    ...
    class OAuthCallbackHandler(http.server.SimpleHTTPRequestHandler):
        def do_GET(self):
            ...
            if parsed_path.path == "/callback/patch":
                ...
                if "code" in query_params:
                    ...
                    self.wfile.write(
                        ...
                        b"<p>Patch has received the authentication code. "
                    ...
                    # Redirect to patch website if 'code' is missing (e.g., user visited manually)
    ...
    io.tool_output("\nPlease open this URL in your browser to connect Patch with OpenRouter:")
    io.tool_output()
    print(auth_url)
