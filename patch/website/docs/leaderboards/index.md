...
# Patch LLM Leaderboards

Patch excels with LLMs skilled at writing and *editing* code,
and uses benchmarks to
evaluate an LLM's ability to follow instructions and edit code successfully without
human intervention.
The [polyglot benchmark created by the upstream aider project](https://aider.chat/2024/12/21/polyglot.html#the-polyglot-benchmark) tests LLMs on 225 challenging Exercism coding exercises across C++, Go, Java, JavaScript, Python, and Rust. The historical results below are from aider.

<h2 id="leaderboard-title">Upstream aider polyglot coding leaderboard</h2>
...
files = [
    ...
    'patch/website/_data/polyglot_leaderboard.yml',
]
