...
Start working with patch and OpenAI on your codebase:
...
patch --list-models openai/
```

You can use `patch --model <model-name>` to use any other OpenAI model.
For example, if you want to use a specific version of GPT-4 Turbo
you could do `patch --model gpt-4-0125-preview`.
...
Patch is configured to work properly with these models
