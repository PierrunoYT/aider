...
parent: More info
nav_order: 490
description: Patch uses various "edit formats" to let LLMs edit source files.
---

# Edit formats

Patch uses various "edit formats" to let LLMs edit source files.
Different models work better or worse with different edit formats.
Patch is configured to use the optimal format for most popular, common models.
...
The actual edit format is the same, but patch uses a simpler prompt that
