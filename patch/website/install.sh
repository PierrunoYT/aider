...
install() {
    ...
    say ""
    say "Installing patch..."
    say ""
    # Install patch-code using the newly installed uv
    ensure "${_install_dir}/uv" tool install --force --python python3.12 --with pip patch-code@latest
