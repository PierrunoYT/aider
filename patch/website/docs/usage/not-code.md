...
parent: Usage
nav_order: 901
description: Use patch to edit configuration files, documentation, and other text-based formats.
---


# Editing config & text files

Patch isn't just for code, it can be very helpful when editing
almost any text file.
You can use patch to make changes to your shell & ssh settings, 
Dockerfiles
...
<div class="chat-transcript" markdown="1">
$ patch Dockerfile docker-compose.yml
