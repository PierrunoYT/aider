...
class BenchmarkPlotter:
    ...
    def save_and_display(self, fig: plt.Figure):
        plt.savefig("patch/website/assets/models-over-time.png")
        plt.savefig("patch/website/assets/models-over-time.svg")
        imgcat(fig)
...
def main():
    ...
    models = plotter.load_data("patch/website/_data/edit_leaderboard.yml")
    ...
    plotter.plot("patch/website/_data/edit_leaderboard.yml")
